...
describe('Tag', () => {
  ...
  it('should create a tag with attribute', () => {
    expectToBe(new Tag('a', { href: 'http://tests.com', target: '_blank' }), '<a href="http://tests.com" target="_blank"></a>');
  });
  ...
  it('should create a self-closing tag with attributes.', () => {
    expectToBe(new Tag('img', { src: 'image.jpg', alt: 'Image' }), '<img src="image.jpg" alt="Image">');
  });
  it('should handle multiple attributes correctly', () => {
    expectToBe(new Tag('input', { text: 'text', value: 'Sample' }), '<input text="text" value="Sample">');
  });
  ...
  it('should correctly format with both attributes and content', () => {
    ...
    expectToBe(tag, '<a href="http://tests.com" target="_blank">Some content</a>');
  });
});
